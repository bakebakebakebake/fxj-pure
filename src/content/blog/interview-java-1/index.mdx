...
流程图：
![](./Pasted image 20241210161902.png)
**(重)**
...
#### HashMap 的扩容机制是什么？
流程图：
![](./Pasted image 20241210183948.png)
...
#### HashMap 的寻址算法？
![](./Pasted image 20241210193345.png)
...
### 双向链表与双向循环链表
![](https://oss.javaguide.cn/github/javaguide/cs-basics/data-structure/bidirectional-linkedlist.png)

![](https://oss.javaguide.cn/github/javaguide/cs-basics/data-structure/bidirectional-circular-linkedlist.png)
...
![](https://oss.javaguide.cn/github/javaguide/java/collection/treemap_hierarchy.png)
...
![](https://oss.javaguide.cn/github/javaguide/java/collection/jdk1.8_hashmap.png)
...
![](./Pasted image 20241216185425.png)
...
![](./Pasted image 20241205190953.png)
