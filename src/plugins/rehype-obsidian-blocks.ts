...
function createCollapse(
  ...
  return h(
    `details.obsidian-collapse.not-prose.my-4.rounded-xl.border.px-3.py-2.sm:px-4.aside-${type}`,
    open ? { open: true } : {},
    [
      h('summary.obsidian-collapse-summary.cursor-pointer.font-medium', title),
